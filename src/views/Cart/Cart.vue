<template>
  <div class="container">
    ...
    <div v-for="cartItem in cartItems" :key="cartItem.product.id" class="row mt-2 pt-3 justify-content-around">
      ...
      <div class="col-md-5 px-3">
        <div class="card-block px-3">
          ...
          <br /><a href="#" class="text-right" @click="deleteItem(cartItem.id)">Удалить из корзины</a>
        </div>
      </div>
      <div class="col-2"></div>
      <div class="col-12">
    ...
    <div class="total-cost pt-2 text-right">
      <h5>Общая цена : $ {{ totalcost.toFixed(2) }}</h5>
        ...
        (response) => {
          if (response.status == 200) {
            ...
            this.cartItems.forEach(cartProduct => {
              totalCost += cartProduct.quantity * cartProduct.product.price;
            });
